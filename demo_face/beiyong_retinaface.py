...
class Retinaface(object):
    _defaults = {
        ...
        #   retinaface训练完的权值路径
        # ----------------------------------------------------------------------#
        "retinaface_model_path": '/workspace/track/demo_face/model/Retinaface_resnet50.pth',
        # ----------------------------------------------------------------------#
        ...
        #   训练完的权值路径
        # ----------------------------------------------------------------------#
        "Re_model_path": '/workspace/track/demo_face/model/backbone_ir50_asia.pth',
        # ----------------------------------------------------------------------#
        #   使用的主干网络
        # ----------------------------------------------------------------------#
        "backbone": "Ir_50",
    ...
    def load_face_features(self, encoding):
        try:
            self.known_face_encodings = np.load(
                f"/home/wanghu/workspace/test/Track/demo_face/model/{self.backbone}_face_encoding.npy")
            self.known_face_names = np.load(
                f"/home/wanghu/workspace/test/Track/demo_face/model/{self.backbone}_names.npy")
        except:
            if not encoding:
