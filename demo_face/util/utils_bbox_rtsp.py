...
def retinaface_correct_boxes(result, input_shape, image_shape):
    ...
    scale_for_boxs = torch.tensor([scale[1], scale[0], scale[1], scale[0]])
    scale_for_landmarks = torch.tensor([scale[1], scale[0], scale[1], scale[0], scale[1], scale[0], scale[1], scale[0], scale[1], scale[0]])

    offset_for_boxs = torch.tensor([offset[1], offset[0], offset[1], offset[0]])
    offset_for_landmarks = torch.tensor([offset[1], offset[0], offset[1], offset[0], offset[1], offset[0], offset[1], offset[0], offset[1], offset[0]])

    result[:, :4] = (result[:, :4] - offset_for_boxs) * scale_for_boxs
    result[:, 5:] = (result[:, 5:] - offset_for_landmarks) * scale_for_landmarks
